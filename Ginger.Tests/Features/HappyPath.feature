...
Background: 
   Given the following Patterns
    ...
    | ----| ------------------------------------------------------| ----------------------------------------------------------|
    | 6-1 | ботинок{и проч.} ~находится{мн.}~ на одной стороне    | находиться(ботинок, ОднаСторона),                         |
    |     | лужи(род., ед.), а медведь ~находится~ на другой      | находиться(медведь, ДругаяСторона),                       |
    |     | стороне лужи(род., ед.)                               | сторона(лужа, ОднаСторона),                               |
    |     |                                                       | сторона(лужа, ДругаяСторона)                              |
    | ----| ------------------------------------------------------| ----------------------------------------------------------|
    ...
    |     |                                                       |                    @understand('условие').                |
    |-----|-------------------------------------------------------|-----------------------------------------------------------|
    | 10  | история завершается катастрофой                       | завершаться(история, катастрофа)                          |
    |-----|-------------------------------------------------------|-----------------------------------------------------------|
    | 11  | Программа прерывается ошибкой с сообщением            | прерываться(программа, ошибка,                            |
    |     | 'что-то пошло не так'                                 |                    сообщение('что-то пошло не так'))      |
    | ----| ------------------------------------------------------| ----------------------------------------------------------|
