...
Background: 
    ...
    | Id  | Pattern                                               | Meaning                                                   |
    | ----| ------------------------------------------------------| ----------------------------------------------------------|
    | 0   | Множество имярек состоит из следующих элементов:      | множество(имярек, [голубой]).                             |
    |     |   голубой {и проч.}                                   |                                                           |
    | ----| ------------------------------------------------------| ----------------------------------------------------------|
    | 1   | Сфера ~имеет~ внешнюю и внутреннюю поверхности        | @understand(множество @имярек(поверхность, Сфера) состоит |
    |     |                                                       |  из следующих элементов: внешний и внутренний)             |
    | ----| ------------------------------------------------------| ----------------------------------------------------------|
