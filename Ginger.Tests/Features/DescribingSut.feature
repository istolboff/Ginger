...
Background: 
    ...
    |     | конце острова а заяц располагается на ~другом~ конце  |     располагаться(медведь, ОдинКонец),                    |
    |     | острова, то история завершается катастрофой с         |     располагаться(заяц, ДругойКонец),                     |
    |     | диагнозом апперцепция                                 |     конец(остров, ОдинКонец),                             |
