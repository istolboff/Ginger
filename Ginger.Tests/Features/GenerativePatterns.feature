...
Scenario: Предложение с единственным объектом обобщается на случай, когда перечисляется несколько объектов
    ...
    |    | конце острова(род.), а заяц располагается на другом конце        |    :-                                   |
    ...
    |----|------------------------------------------------------------------|---------------------------------------- |
    | 5  | сейчас медведь лежит на ~∥(одной, другой)~ стороне улицы         | сейчас([                                |
    |    |                                                                  |        лежать(медведь, на, X),          |
    |    |                                                                  |        сторона(улица, X),               |
    |    |                                                                  |        X = '∥'                          |
    |    |                                                                  |     ]).                                 |
    ...
    |                                                       |    шар(X), зеленый(X).                   |                         |
    |-------------------------------------------------------|------------------------------------------|-------------------------| 
    | Если волк и коза находятся на одном береге реки,      | заканчиваться(миссия, неудача)           | 4                       |
    ...
    |-------------------------------------------------------|------------------------------------------|-------------------------| 
    | сегодня фермер находится на одном береге реки         | сегодня([                                | 5                       |
    |                                                       |    находиться(фермер, на, X),            |                         |
    |                                                       |    берег(река, X),                       |                         |
    |                                                       |    X = один                              |                         |
    |                                                       |   ]).                                    |                         |
    |-------------------------------------------------------|------------------------------------------|-------------------------| 
    | сегодня фермер находится на другом береге реки        | сегодня([                                | 5                       |
    |                                                       |    находиться(фермер, на, X),            |                         |
    |                                                       |    берег(река, X),                       |                         |
    |                                                       |    X = другой                            |                         |
    |                                                       |   ]).                                    |                         |
